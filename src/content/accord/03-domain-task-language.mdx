...
order: 3
number: 3
title: Open models are built at the scope of a specific domain, task, and language.
anchor: section-3
layers: [D, R]
summary: Build for one domain, one task, one language mix — and own the result.
---
